...
class ReportAccountAgedPartnerInherit(models.AbstractModel):
    ...
    period8 = fields.Monetary(string='Older')
    ...
    def _get_sql(self):
        ...
        query = ("""
                SELECT
                    ...
                    ELSE 0 END AS period{i}""").format(i=i) for i in range(9)]) + """
    ...
    def _get_column_details(self, options):
        return [
            ...
            self._custom_column(  # Avoid doing twice the sub-select in the view
                ...
                getter=(lambda v: v['period0'] + v['period1'] + v['period2'] + v['period3'] + v['period4'] + v[
                    'period5'] + v['period6']+ v['period7']+ v['period8']),
                sortable=True,
            ),
        ]
    ...
    def _show_line(self, report_dict, value_dict, current, options):
        ...
        all_zero = all(
            ...
            for f in ['period0', 'period1', 'period2', 'period3', 'period4', 'period5', 'period6', 'period7', 'period8']
        )
