...
class MulticurrencyRevaluationReport(models.Model):
    ...
    def _get_sql(self):
        ...
        return """
            ...
            WHERE ((account.currency_id != aml.company_currency_id AND account.currency_revaluation = true) OR (account.internal_type IN ('receivable', 'payable') AND (aml.currency_id != aml.company_currency_id)))
