# -*- coding: utf-8 -*-
{
    ...
    'description': """
               ...
               """,
    'sequence': 51,
    'depends': ['hr', 'account', 'mail', 'freight', 'crm', 'base', 'uom', 'ebs_freight_pricing', 'sale_management', 'web','account_asset','account_budget','operating_unit','analytic','account_operating_unit'],
